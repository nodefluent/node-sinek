...
import {ConsumerGroup, Offset, KafkaClient, HighLevelProducer, ConsumerGroupOptions} from "kafka-node";
...
export default class Kafka extends EventEmitter {
    ...
    constructor(private conString: string, logger: object, private connectDirectlyToBroker: boolean = false) {
