...
class Drainer {
     ...
     */
    close() {
        this.raw.removeListener("message", this._onMessage);
    ...
    drain(drainEvent = null) {
        ...
        this._timSinceLastDrain = this._totalIncomingMessages;
        ...
        return new Promise((resolve, reject) => {
            ...
            intv = setInterval(() => {
                ...
                if(span >= drainThreshold){
                    ...
                    clearTimeout(t);
                    this.stopDrain();
                    resolve(this._totalIncomingMessages - this._timSinceLastDrain);
                }
            }, DRAIN_INTV);
    ...
    _startToReceiveMessages(){
        ...
        this.raw.on("message", this._onMessage.bind(this));
