...
class PartitionDrainerDrainer {

    constructor(consumer = null, asyncLimit = 1, commitOnDrain = false) {
    ...
    resetOffset(topics){
        ...
        return Promise.all(topics.map(t => this.consumer.hardOffsetReset(t))).then(_ => {
            if(!this.isPaused()){
                this.pause();
            }
            return true;
...
module.exports = PartitionDrainerDrainer;
